## What I did for reproducing
### 1. Fixed some typos
There were some typos in `train.py`, so fixed it.
> `InstructorTransformer` -> `INSTRUCTORransformer`<br>
`Instructor` -> `INSTRUCTOR`

### 2. Modified `_load_sbert_model`
`_load_sbert_model` method in `INSTRUCTOR` was copied from https://github.com/UKPLab/sentence-transformers/blob/66e0ee30843dd411c64f37f65447bb38c7bf857a/sentence_transformers/util.py#L559. But, the method in the package was changed. So, I changed the function in the same way.

### 3. Reduced data size
For quicker reproducing, I reduced the data size by 1/10000. I grouped data by task ID, randomized each group, and extracted 1/10000 of the data.

## Limitation
I didn't solve the saving problem.<br>
After training, the error same with below occurred.
>RuntimeError:
...
<br><br><br><br><br><br>
From here is the copy of README.md of instructor-embedding
<br><br><br><br><br><br>
